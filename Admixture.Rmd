...
awk -v FS=" " 'NF>19' pcadmix_lp23.s00001.markers.txt | cut -f2- | cut -d " " -f1 | head -1 | cut -d ":" -f2 # 6927 - scaffold START
awk -v FS=" " 'NF>19' pcadmix_lp23.s00001.markers.txt | cut -f2- | cut -d " " -f20 | tail -1 | cut -d ":" -f2 # 13182611 - scaffold END
...
# window number
paste -d '.' <(awk -v FS=" " 'NF>19' pcadmix_lp23.s00001.markers.txt | cut -f1 | grep -o "Window") <(seq -f "%03g" 1 $(awk -v FS=" " 'NF>19' pcadmix_lp23.s00001.markers.txt | wc -l))
...
# Start position
awk -v FS=" " 'NF>19' pcadmix_lp23.s00001.markers.txt | cut -f2- | cut -d " " -f1 | cut -d ":" -f2

# End position 
awk -v FS=" " 'NF>19' pcadmix_lp23.s00001.markers.txt | cut -f2- | cut -d " " -f20 | cut -d ":" -f2
...
paste <(paste -d '.' <(awk -v FS=" " 'NF>19' pcadmix_lp23.s05219.markers.txt | cut -f1 | grep -o "Window") <(seq -f "%03g" 1 $(awk -v FS=" " 'NF>19' pcadmix_lp23.s05219.markers.txt | wc -l))) <(rev pcadmix_lp23.s05219.vit.txt | cut -d " " -f3- | rev | grep h_ll_pv_0223_A | tr ' ' '\n' | grep -v "h_ll_pv_0223_A") <(rev pcadmix_lp23.s05219.vit.txt | cut -d " " -f3- | rev | grep h_ll_pv_0223_B | tr ' ' '\n' | grep -v "h_ll_pv_0223_B") <(awk -v FS=" " 'NF>19' pcadmix_lp23.s05219.markers.txt | cut -f2- | cut -d " " -f1 | cut -d ":" -f2) <(awk -v FS=" " 'NF>19' pcadmix_lp23.s05219.markers.txt | cut -f2- | cut -d " " -f20 | cut -d ":" -f2) > table2.txt
...
# paste everything - SHOULD ADD SCAFFOLD number AND ALLELE (A or B) -> awk ?
paste A_2_windows <(grep -f A_2_starts table2.txt | cut -f4) <(grep -f A_2_ends table2.txt | cut -f5) > table3.txt
