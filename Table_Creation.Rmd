...
# 1. Three Tables generator executable Script
...
Ran the script once with the PV individual in PCAdmix_Results folder.
This loop can be run to extract the tables of all individuals in Particular Population (in this case CR and KI)
